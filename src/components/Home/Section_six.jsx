          ...
          <div className='sm:items-end justify-between sm:flex gap-10'>
            ...
            <div className='md:flex gap-4 items-center justify-center lg:mt-0'>
              ...
              <button
                ...
                className='rounded-full border border-gray-300 p-5 text-gray-600 transition hover:bg-blue-600 hover:text-white'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
          ...
          <div className='grid md:grid-cols-3 gap-5 py-16'>
            <div className='keen-slider__slide'>
              <blockquote className='flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12'>
                ...
                <footer className='mt-4 text-sm font-medium text-red-500 sm:mt-6'>
                  &mdash; Michael Scott
                </footer>
              </blockquote>
            </div>
